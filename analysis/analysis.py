# analysis.py — Dengue Global: Base de Datos de Casos por País (1995-2024)
...
print(f"Dataset: Dengue Global: Base de Datos de Casos por País (19")
print(f"DOI: 10.5281/zenodo.18881116")
...
fig.suptitle("Dengue Global: Base de Datos de Casos por País (1995-2024)", fontsize=11, fontweight="bold")
...
print(f"""
Citation:
de la Serna Tuya, Juan Moisés (2026). Dengue Global: Base de Datos de Casos por País (1995-2024). Zenodo. https://doi.org/10.5281/zenodo.18881116
""")
